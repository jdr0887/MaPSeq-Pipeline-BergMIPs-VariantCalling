package edu.unc.mapseq.ws.bergmips.vc.impl;
...
import edu.unc.mapseq.ws.bergmips.vc.MetricsResult;

public class BergMIPsVariantCallingServiceImpl implements BergMIPsVariantCallingService {

    private static final Logger logger = LoggerFactory.getLogger(BergMIPsVariantCallingServiceImpl.class);
    ...
    public BergMIPsVariantCallingServiceImpl() {
        super();
    }

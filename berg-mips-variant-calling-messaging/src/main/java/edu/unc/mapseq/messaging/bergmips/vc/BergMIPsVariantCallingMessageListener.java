...
public class BergMIPsVariantCallingMessageListener extends AbstractSequencingMessageListener {

    private static final Logger logger = LoggerFactory.getLogger(BergMIPsVariantCallingMessageListener.class);

    public BergMIPsVariantCallingMessageListener() {
        super();
    }

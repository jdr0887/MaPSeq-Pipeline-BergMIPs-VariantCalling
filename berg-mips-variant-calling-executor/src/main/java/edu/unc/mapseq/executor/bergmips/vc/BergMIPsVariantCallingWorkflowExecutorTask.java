...
import edu.unc.mapseq.workflow.bergmips.vc.BergMIPsVariantCallingWorkflow;

public class BergMIPsVariantCallingWorkflowExecutorTask extends TimerTask {

    private static final Logger logger = LoggerFactory.getLogger(BergMIPsVariantCallingWorkflowExecutorTask.class);
    ...
    public BergMIPsVariantCallingWorkflowExecutorTask() {
        super();
    }
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(attempts)) {
                ...
                for (WorkflowRunAttempt attempt : attempts) {
                    ...
                    BergMIPsVariantCallingWorkflow alignmentWorkflow = new BergMIPsVariantCallingWorkflow();
